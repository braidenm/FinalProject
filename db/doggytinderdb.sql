...
INSERT INTO `dog` (`id`, `user_id`, `name`, `breed`, `weight`, `energy`, `age`, `about`, `active`, `sex`) VALUES (14, 3, 'Martha', 'Neopolitan Mastiff', 125, 4, 6, 'Drooooooooooooool.', 1, 'Female');
INSERT INTO `dog` (`id`, `user_id`, `name`, `breed`, `weight`, `energy`, `age`, `about`, `active`, `sex`) VALUES (15, 3, 'SweePee Rambo', 'Chinese Crested Chihuahua', 5, 8, 17, 'OMG', 1, 'Female');
