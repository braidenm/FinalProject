...
START TRANSACTION;
USE `doggytinderdb`;
INSERT INTO `dog` (`id`, `user_id`, `name`, `breed`, `weight`, `energy`, `age`, `about`, `active`, `sex`) VALUES (1, 1, 'Asher', 'Mutt', 55, 7, 3, 'I\'m Jimmy\'s dog.', 1, 'Male');
INSERT INTO `dog` (`id`, `user_id`, `name`, `breed`, `weight`, `energy`, `age`, `about`, `active`, `sex`) VALUES (2, 2, 'The Revolution', 'Chihuahua', 4, 8, 7, 'Yo quiero libertad. Y Taco Bell.', 1, 'Male');
INSERT INTO `dog` (`id`, `user_id`, `name`, `breed`, `weight`, `energy`, `age`, `about`, `active`, `sex`) VALUES (3, 3, 'Little Dude', 'Bulldog', 45, 2, 4, 'I sit, I stay, I abide.', 1, 'Male');
...
INSERT INTO `dog` (`id`, `user_id`, `name`, `breed`, `weight`, `energy`, `age`, `about`, `active`, `sex`) VALUES (5, 5, 'Kissy', 'Toy Fox Terrier', 15, 8, 6, 'I prefer dogcci and other high end brands. Check me out on the \'gram.', 1, 'Female');
INSERT INTO `dog` (`id`, `user_id`, `name`, `breed`, `weight`, `energy`, `age`, `about`, `active`, `sex`) VALUES (6, 6, 'Andy', 'Fox Terrier', 18, 7, 3, 'I\'m Andy the dog. Hello.', 1, 'Male');
INSERT INTO `dog` (`id`, `user_id`, `name`, `breed`, `weight`, `energy`, `age`, `about`, `active`, `sex`) VALUES (7, 7, 'Daisy', 'Labrador Retriever', 60, 6, 6, 'I\'m a jetsetting, high flying doggo. I\'m not a wolf, but I may have been one in a previous life.', 1, 'Female');
INSERT INTO `dog` (`id`, `user_id`, `name`, `breed`, `weight`, `energy`, `age`, `about`, `active`, `sex`) VALUES (8, 8, 'Daddy', 'American Pit Bull Terrier', 49, 3, 16, 'I\'m really well trained.', 1, 'Male');
...
INSERT INTO `dog` (`id`, `user_id`, `name`, `breed`, `weight`, `energy`, `age`, `about`, `active`, `sex`) VALUES (10, 10, 'Oprah', 'Schnauzer', 4, 7, 10, 'Apparently my owner doesn\'t really love Mrs. Winfrey all that much.', 1, 'Female');
INSERT INTO `dog` (`id`, `user_id`, `name`, `breed`, `weight`, `energy`, `age`, `about`, `active`, `sex`) VALUES (11, 11, 'Poppy Raymond', 'Goldendoodle', 40, 6, 8, 'Yeah! Yeah! Yeah! Yeah! Yeah! Yeah! Yeah!', 1, 'Male');
...
INSERT INTO `dog` (`id`, `user_id`, `name`, `breed`, `weight`, `energy`, `age`, `about`, `active`, `sex`) VALUES (13, 21, 'Zsa Zsa', 'English Bulldog', 35, 3, 9, 'I may be ugly but I\'ve got a heart of gold.', 1, 'Female');
INSERT INTO `dog` (`id`, `user_id`, `name`, `breed`, `weight`, `energy`, `age`, `about`, `active`, `sex`) VALUES (14, 21, 'Martha', 'Neopolitan Mastiff', 125, 4, 6, 'Drooooooooooooool.', 1, 'Female');
INSERT INTO `dog` (`id`, `user_id`, `name`, `breed`, `weight`, `energy`, `age`, `about`, `active`, `sex`) VALUES (15, 21, 'SweePee Rambo', 'Chinese Crested Chihuahua', 5, 8, 17, 'OMG', 1, 'Female');
INSERT INTO `dog` (`id`, `user_id`, `name`, `breed`, `weight`, `energy`, `age`, `about`, `active`, `sex`) VALUES (16, 21, 'Quasi Modo', 'Pit Bull/Dutch Shepherd', 50, 5, 10, 'I kinda look like a chupacabra.', 1, 'Female');
INSERT INTO `dog` (`id`, `user_id`, `name`, `breed`, `weight`, `energy`, `age`, `about`, `active`, `sex`) VALUES (17, 13, 'Bobo', 'Great Dane', 160, 4, 5, 'Not quite as fast as master. I know Kung Fu.', 1, 'Male');
INSERT INTO `dog` (`id`, `user_id`, `name`, `breed`, `weight`, `energy`, `age`, `about`, `active`, `sex`) VALUES (18, 14, 'Bella', 'Shorkie (Shitzu/Yorkie)', 4, 6, 4, 'I hold it down at SD. Well behaved.', 1, 'Female');
INSERT INTO `dog` (`id`, `user_id`, `name`, `breed`, `weight`, `energy`, `age`, `about`, `active`, `sex`) VALUES (19, 15, 'Adobo', 'Jindo', 20, 5, 5, 'I\'m a dj. And also a dog. Wicka wicka yeah!', 1, 'Male');
INSERT INTO `dog` (`id`, `user_id`, `name`, `breed`, `weight`, `energy`, `age`, `about`, `active`, `sex`) VALUES (20, 16, 'Nugget', 'Border Terrier', 13, 6, 5, 'You\'re a wizard, harry! But I\'m a dog.', 1, 'Male');
...
INSERT INTO `dog` (`id`, `user_id`, `name`, `breed`, `weight`, `energy`, `age`, `about`, `active`, `sex`) VALUES (23, 17, 'Brutus', 'French Bulldog', 8, 4, 1, 'I may looks cute but I\'m dangerous. I\'m a bad boy. Really, I am. Better not mess with me. Unless you wanna play.', 1, 'Male');
...
INSERT INTO `dog` (`id`, `user_id`, `name`, `breed`, `weight`, `energy`, `age`, `about`, `active`, `sex`) VALUES (25, 20, 'Comrad', 'Mutt', 12, 7, 3, 'Seize the means of production, dograde. We shall all enjoy the products of our sits and stays. Redistribute the kibble!', 1, 'Male');
...
INSERT INTO `likes` (`id`, `this_dog`, `that_dog`) VALUES (11, 1, 4);
INSERT INTO `likes` (`id`, `this_dog`, `that_dog`) VALUES (12, 4, 2);
INSERT INTO `likes` (`id`, `this_dog`, `that_dog`) VALUES (13, 1, 3);
INSERT INTO `likes` (`id`, `this_dog`, `that_dog`) VALUES (14, 4, 3);
INSERT INTO `likes` (`id`, `this_dog`, `that_dog`) VALUES (15, 7, 3);
INSERT INTO `likes` (`id`, `this_dog`, `that_dog`) VALUES (16, 7, 2);
INSERT INTO `likes` (`id`, `this_dog`, `that_dog`) VALUES (17, 2, 10);
INSERT INTO `likes` (`id`, `this_dog`, `that_dog`) VALUES (18, 10, 2);
INSERT INTO `likes` (`id`, `this_dog`, `that_dog`) VALUES (19, 3, 11);
INSERT INTO `likes` (`id`, `this_dog`, `that_dog`) VALUES (20, 10, 3);
INSERT INTO `likes` (`id`, `this_dog`, `that_dog`) VALUES (21, 3, 7);
INSERT INTO `likes` (`id`, `this_dog`, `that_dog`) VALUES (22, 31, 3);
INSERT INTO `likes` (`id`, `this_dog`, `that_dog`) VALUES (23, 32, 3);
INSERT INTO `likes` (`id`, `this_dog`, `that_dog`) VALUES (24, 33, 3);
INSERT INTO `likes` (`id`, `this_dog`, `that_dog`) VALUES (25, 34, 3);
INSERT INTO `likes` (`id`, `this_dog`, `that_dog`) VALUES (26, 18, 3);
INSERT INTO `likes` (`id`, `this_dog`, `that_dog`) VALUES (27, 18, 2);
INSERT INTO `likes` (`id`, `this_dog`, `that_dog`) VALUES (28, 22, 2);
INSERT INTO `likes` (`id`, `this_dog`, `that_dog`) VALUES (29, 2, 22);
INSERT INTO `likes` (`id`, `this_dog`, `that_dog`) VALUES (30, 22, 3);
INSERT INTO `likes` (`id`, `this_dog`, `that_dog`) VALUES (31, 3, 22);
INSERT INTO `likes` (`id`, `this_dog`, `that_dog`) VALUES (DEFAULT, 2, 18);
...
INSERT INTO `matches` (`id`, `dog1_id`, `dog2_id`) VALUES (5, 3, 7);
INSERT INTO `matches` (`id`, `dog1_id`, `dog2_id`) VALUES (6, 2, 10);
INSERT INTO `matches` (`id`, `dog1_id`, `dog2_id`) VALUES (7, 2, 22);
INSERT INTO `matches` (`id`, `dog1_id`, `dog2_id`) VALUES (8, 3, 22);
INSERT INTO `matches` (`id`, `dog1_id`, `dog2_id`) VALUES (9, 2, 18);
